...
<div id="cont_box">
  <div class="page_title">
    ...
    <ul>
      <li>
      <img src="../../images/sub/community/cooperative_firm.png" alt="협력업체 그림"/>
      <div id="career_text">
          <span class="page_sub_text">위드프랭즈 교육원과 함께 할 “협력업체”를  모십니다.</span>
        <p class="sub_text">
          · 위드프랭즈 교육원에서는 원장님께서 필요로 하는 보다 편리하고 종합적인<br />
          서비스를 제공해 드리기 위해서 함께 하실 협력업체를 모십니다.<br />
          · 위드프랭즈 교육원과 함께 서로 도와가며 WIN-WIN 할 수 있는 업체면 좋겠습니다. <br /><br />
          <span><strong>문의 : 02-6433-6001  또는 010-9023-7171  사업부 이사 남기훈</strong></span><br/>
        </p>
      </div>  
      </li>
      <li>      </li>
