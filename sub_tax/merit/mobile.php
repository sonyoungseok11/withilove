...
<div id="cont_box">
	<div class="page_title">모바일 버전 제공</div>
	<ul>
        <li>
            <span class="page_sub_text">어플을 통한 관리파일 제공으로</span>
            <p class="sub_text">
            · 어플을 통해서 <span><b>월별 수입금 자동 조회 및 인건비</b></span>등의 주요비용을 매달 간편하게 확인할 수 있습니다.<br/>
            · 컴퓨터를 켜지 않고도 핸드폰으로 편리하게 학원 현황을 파악하실 수 있습니다. 
            </p>
        </li>
    </ul>
</div>
