...
<div id="cont_box">
  <div class="page_title">이메일 상담</div>
    <ul>
        <li>
          <span class="page_sub_text">이메일로 진로/진학 상담을 원하시는 경우</span>
            <p class="sub_text">
            · <a href="mailto:tax_master@withfriengs.com">oats2@naver.com</a>로 이메일을 보내주세요.<br/>
            · 진로/진학에 관해 무엇이든 상담해 드립니다.<br />
            · 이메일에 <span><strong>학원명, 대표자, 휴대전화번호, 학원 소재지, 학원 전화번호</strong></span>를 기입해서 보내주시면<br />
            &nbsp;더욱 자세한 상담이 가능합니다.<br/>
          </p>
      </li>
    <li>
       <span class="page_sub_text">전화(02-6433-6001)로 진로/진학  상담을 원하시는 경우</span>
            <p class="sub_text">
            · 02-6433-6001 번으로 전화주세요.<br/>
            · 진로/진학에 관해 무엇이든 상담해 드립니다.<br/>
            · 전화 상담 시에 <span><strong>학원명, 대표자, 휴대전화번호, 학원 소재지, 학원 전화번호</strong></span>를 알려주시면<br />
            &nbsp;더욱 자세한 상담이 가능합니다.<br/>
      </p>
      </li>
    </ul>
