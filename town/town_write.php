...
<form action="town_proc.php" method="post" enctype="multipart/form-data" onSubmit="return check_form(this);">
...
<ul class="town_form">
	...
	<li>
		<div class="lh">
			...
			<a href="#" class="jButton small fileMinus">&minus;</a>
		</div>
		<?=$file_inputs?>
	</li>
</ul>
